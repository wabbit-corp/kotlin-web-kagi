...
object Kagi {
    ...
    fun computeCost(model: Model, tokens: Int): Double {
        // Consumer models
        // Price for our consumer-grade models (Cecil and Agnes) is $0.030 USD per 1,000 tokens
        // processed. If you are subscribed to the Kagi Ultimate plan, discounted pricing at $0.025
        // per 1,000 tokens processed is automatically applied.
        //
        // Notes:
        //
        // Tokens include all tokens processed in + out.
        // Any request over 10,000 tokens is billed as 10,000 tokens, regardless of the length of
        // the document.
        // Accessing cached summaries of the same URL is always free.
        // Enterprise models
        // Our enterprise-grade Muriel summarization engine produces even higher quality summaries,
        // especially for long documents. It also provides longer and more detailed summaries than
        // our consumer-grade model. See the difference here.
        //
        // Muriel usage is a flat rate of $1 USD per summary, regardless of the length or type of
        // the document.
        //
        // To use Muriel just use "muriel" as the "engine" parameter in the API call. See examples
        // below.
        return when (model) {
            Model.agnes,
            Model.cecil -> {
    ...
    suspend fun execute(
        ...
        val response =
            httpClient.get("https://kagi.com/api/v0/summarize") {
                parameter("url", req)

...
// managed-integrity-v1: 6tD8McREEdE
//
...
mavenPublishing {
    coordinates("one.wabbit", "kotlin-web-kagi", project.version.toString())
    publishToMavenCentral()
    signAllPublications()
    pom {
        name.set("kotlin-web-kagi")
        description.set("kotlin-web-kagi")
        url.set("https://github.com/wabbit-corp/kotlin-web-kagi")
        licenses {
            license {
        ...
        scm {
            url.set("https://github.com/wabbit-corp/kotlin-web-kagi")
            connection.set("scm:git:git://github.com/wabbit-corp/kotlin-web-kagi.git")
            developerConnection.set("scm:git:ssh://git@github.com/wabbit-corp/kotlin-web-kagi.git")
        }
    }
}
...
publishing {
    publications.withType<org.gradle.api.publish.maven.MavenPublication>().configureEach {
        val configuredArtifactId = "kotlin-web-kagi"
        ...
        extensions.findByType(DokkaExtension::class)?.apply {
            ...
            dokkaSourceSets.configureEach {
                ...
                sourceLink {
                    ...
                    remoteUrl("https://github.com/wabbit-corp/kotlin-web-kagi/tree/master/src")

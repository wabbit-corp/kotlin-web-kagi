...
kover {
    ...
    //             // title.set("kotlin-web-kagi Code Coverage") // Uncomment to customize title
    //         }
    //         xml {
...
dokka {
    moduleName.set("kotlin-web-kagi")
    ...
    dokkaSourceSets.main {
        ...
        sourceLink {
            ...
            remoteUrl("https://github.com/wabbit-corp/kotlin-web-kagi/tree/master/src/main/kotlin")
